...
int getInteger(LPCSTR text = "BLANK");//限制输入为整形的输入框，可改变 对话框提示文字
double getDouble(LPCSTR text = "BLANK");//限制输入为浮点数的输入框，可改变 对话框提示文字
void getString(char str[], int length, LPCSTR text = "BLANK");//限制输入内容长度的字符串输入框，可改变 对话框提示文字
char getChar(LPCSTR text = "BLANK");//限制输入为字符的输入框，可改变 对话框提示文字
void getCoords(int tops[], int side, LPSTR title = "WELCOME");//限制输入格式为坐标的输入框，可改变 对话框提示文字
